...
let pmongodb = bluebirdPromise.promisifyAll(mongodb);
...
export async function addPin(userid: string, boardid: string, imageUri: string, link: string, caption: string, callback: (user: User) => void) {
    let coll = await collection('images');
